...
<head>
    ...
    <meta name="description" content="Personal laravel blog build by laravel">
    <meta name="author" content="Jackson Wesonga">
    ...
    {{-- fav icon  --}}
    <link rel="icon" type="image/png" sizes="512x512" href="{{ asset('assets/img/favicon/favicon-512x512.png') }}">
    ...
    <!-- Scripts -->
    @vite(['resources/sass/app.scss', 'resources/css/app.css', 'resources/css/planet-bsb.css', 'resources/js/planet-bsb.js', 'resources/js/app.js'])
</head>

<body>
    <div id="app">
        @if (Route::is('register') || Route::is('login') || Route::is('password.request') || Route::is('password.reset'))
        @else
            <!-- Header -->
            <header id="header" class="sticky-top bsb-tpl-header-sticky bsb-tpl-header-sticky-animationX">

                <!-- Navbar 1 - Bootstrap Brain Component -->
                <nav class="navbar navbar-expand-lg bsb-navbar bsb-navbar-hover bsb-navbar-caret bsb-tpl-navbar-sticky bg-white border-bottom border-light-subtle"
                    data-bsb-sticky-target="#header">
                    <div class="container">
                        <a class="navbar-brand" href="index.html">
                            <img src="{{ asset('assets/img/branding/planet-logo.svg') }}" class="bsb-tpl-logo"
                                alt="">
                        </a>
                                        ...
                                        <ul class="dropdown-menu border-0 shadow bsb-zoomIn"
                                            ...
                                            @forelse ($categories as $category)
                                                <li><a class="dropdown-item"
                                                        href="{{ route('articles.filterByCategory', $category) }}">{{ $category->name }}</a>
                                                </li>
                                            @empty
                                                <li><a class="dropdown-item" href="#">No Category Yet</a></li>
                                            @endforelse
                ...
                <div class="container">
                    <div class="row justify-content-md-center">
                        <div class="col-12 col-md-9 col-lg-8 col-xl-8 col-xxl-7">
                            <h2 class="display-4 fw-bold mb-4 mb-md-5 mb-xxl-6 text-center text-accent-emphasis">Sign
                                up for our newsletter and never miss a thing.</h2>
                        </div>
                    </div>
                    <div class="row justify-content-md-center">
                        <div class="col-12 col-md-10 col-lg-9 col-xl-8 col-xxl-7">
                            <form class="row gy-3 gy-lg-0 gx-lg-2 justify-content-center">
                                <div class="col-12 col-lg-8">
                                    ...
                                    <div id="email-newsletter-help" class="form-text text-center text-lg-start">We'll
                        ...
                        <div class="row gy-3 gy-md-5 gy-xl-0 align-items-sm-center">
                            <div class="col-xs-12 col-sm-6 col-xl-3 order-0 order-xl-0">
                                <div class="footer-logo-wrapper text-center text-sm-start">
                                    <a href="#!">
                                        <img src="./assets/img/branding/planet-logo.svg" alt=""
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <div class="credits text-secondary text-center mt-2 fs-7">
                                    Designed by <a href="https://github.com/WesongaJackson" target="_blank"
                                        class="link-secondary text-decoration-none">WesongaTech</a> with <span
