...
@section('content')
    <div class="container">
                    ...
                    <div class="col-12">
                        ...
                        <div class="row">
                            <div class="col-12 col-md-11 col-lg-8 col-xl-7 col-xxl-6 d-flex gap-3">
                                <p class="lead m-0">—</p>
                                <p class="lead text-secondary m-0">We're always on the lookout to work with new clients.
        ...
        <main id="main">
            ...
            <div class="py-3 py-md-5 py-xl-10">
                <div class="container">
                                ...
                                <div class="col-12 col-xl-11">
                                    <div class="mb-4 mb-md-5">
                                        ...
                                        <div>
                                            ...
                                            <address class="m-0 text-secondary">8014 Edith Blvd NE, Albuquerque, New York,
